		...
		<section className="bg-background py-16 sm:py-24">
			<div className="mx-auto max-w-5xl px-6 lg:px-10">
				...
				<div className="max-w-2xl">
					<p className="anim-fade-up font-medium text-[0.65rem] text-muted-foreground uppercase tracking-[0.16em]">
					...
					<p className="anim-fade-up mt-5 max-w-xl text-pretty text-base text-muted-foreground leading-relaxed [animation-delay:80ms] sm:text-lg">
				...
				<div className="mt-16 grid gap-4 sm:grid-cols-2">
					{standards.map(
						({ name, status, desc, icon: Icon, badgeClass }, i) => (
							<div
								key={name}
								className="anim-fade-up group relative overflow-hidden rounded-none border border-border bg-card p-6 transition-all duration-200 ease-out hover:border-foreground/20 hover:bg-muted/10 hover:shadow-[0_4px_12px_rgba(0,0,0,0.02)] active:scale-[0.98]"
								...
								<div className="flex items-start justify-between">
									<div className="flex items-center gap-3.5">
										...
										<div className="flex flex-col gap-1">
											...
											<Badge
												variant="outline"
												className={`h-4 rounded-none border px-1.5 py-0 font-semibold text-[9px] uppercase tracking-wider ${badgeClass}`}
											>
												{status}
											</Badge>
										</div>
				...
				{/* CTA */}
				<div className="anim-fade-up mt-24 overflow-hidden rounded-none border border-border bg-card p-8 [animation-delay:600ms] sm:p-12">
					<div className="flex flex-col gap-8 sm:flex-row sm:items-center sm:justify-between">
						...
						<a
							...
							className="group inline-flex w-fit items-center justify-center gap-2 rounded-none bg-[#405cfe] px-6 py-3 font-medium text-sm text-white transition-all duration-150 ease-out hover:bg-[#3550e0] active:translate-y-[1px] active:scale-[0.96]"
						>
							Request details
