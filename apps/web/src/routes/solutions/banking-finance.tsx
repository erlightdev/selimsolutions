...
export const Route = createFileRoute("/solutions/banking-finance")({
	component: BankingFinanceSolutionPage,
	head: () => ({
		meta: [
			{ title: "Banking & Financial Cybersecurity Solutions | Selim Solution" },
			{
				name: "description",
				content:
					"High-trust 24/7 security monitoring, VAPT penetration testing, SWIFT terminal auditing, and NRB Directives compliance custom-fit for banks and fintech.",
			},
		],
	}),
});
...
const useCases = [
	{
		number: "01",
		title: "Core Banking Integrity Monitoring",
		description:
			"Continuous telemetry correlation across core databases, transaction interfaces, and ledger configurations to detect internal and external fraud or unauthorized access patterns in real-time.",
		metric: "99.999% Visibility",
	},
	{
		number: "02",
		title: "SWIFT & Payment Gateway Hardening",
		description:
			"Dedicated threat-detection rules tailored for SWIFT terminal logs, card processors, and digital banking APIs, identifying out-of-bounds administrative activity and anomalous session timings.",
		metric: "< 5 Min Containment",
	},
	{
		number: "03",
		title: "NRB IT Guidelines & Compliance Mapping",
		description:
			"Automated alignment of continuous monitoring, access controls, and logging practices directly to Nepal Rastra Bank guidelines, simplifying reporting and third-party audit readiness.",
...
const steps = [
	{
		number: "01",
		title: "Log Aggregation & Local Isolation",
		subtitle: "Sovereign log aggregation agents collect and parse events from SWIFT nodes, core AS400 tables, and identity gateways locally, masking all PII.",
	},
	{
		number: "02",
		title: "NRB & Threat Pattern Correlation",
		subtitle: "Our SIEM engine correlates events against known financial fraud vectors, credential-stuffing patterns, and specific NRB logging directives.",
	},
	{
		number: "03",
		title: "Analyst Triaging & Action",
		subtitle: "Our 24/7 Kathmandu SOC identifies verified indicators of compromise, immediately initiating account lockdown or terminal isolation workflows.",
	},
] as const;

const faqs = [
	{
		question: "How does your SOC map log monitoring to Nepal Rastra Bank (NRB) directives?",
		answer:
			"We integrate continuous security log aggregation, parsing, and correlation routines designed around NRB requirements. We provide standard dashboards and monthly automated audit templates that can be handed directly to regulatory examiners.",
	},
	{
		question: "Can your team monitor legacy AS400 or proprietary core-banking platforms?",
		answer:
			"Yes. Our log collection agents and orchestration integrations ingest, parse, and monitor transaction database updates, OS-level event changes, and administrator activities on specialized core banking environments.",
	},
	{
		question: "What guarantees do you provide regarding banking customer data privacy?",
		answer:
			"We support localized log aggregators, on-premises syslog forwarding, and strict field-level masking. This ensures that personally identifiable customer financial data remains entirely within your sovereign network boundaries.",
	},
] as const;

function BankingFinanceSolutionPage() {
	return (
		<section className="relative isolate overflow-hidden bg-background py-16 sm:py-24">
			...
			<div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10">
				{/* Back navigation with active spring-like scales on click */}
				<Link
					to="/solutions"
				...
				<div className="grid gap-12 lg:grid-cols-12 lg:items-center">
					<div className="lg:col-span-6">
						...
						<h1 className="mt-6 text-balance font-serif text-4xl text-foreground leading-[1.05] tracking-[-0.02em] sm:text-5xl lg:text-6xl">
							Security calibrated to high-value transactions.
						</h1>
						<p className="mt-6 max-w-xl text-pretty text-base text-foreground/75 leading-relaxed sm:text-lg dark:text-zinc-300">
							We defend financial institutions with zero-day threat detection,
							SWIFT-compliant event monitoring, and continuous offensive assessments
							designed to exceed rigorous audit pressures.
						</p>
					...
					<div className="lg:col-span-6">
						<div className="relative rounded-none border border-border/40 bg-card p-6 shadow-2xl transition-all duration-300 hover:border-primary/20">
							...
							<div className="flex items-center justify-between border-border/20 border-b pb-4">
								...
								<span className="rounded-none bg-primary/10 px-2 py-0.5 font-mono text-[9px] font-bold text-primary">
									NRB Directives Mode
								</span>
							</div>
							...
							<div className="mt-5 space-y-4">
								{/* Activity Block 1: DB Transaction Health */}
								<div className="flex items-center justify-between rounded-none border border-border/20 bg-muted/10 p-3">
									<div className="flex items-center gap-3">
										<Database className="h-4 w-4 text-primary" />
										<div>
											<p className="font-serif text-sm text-foreground leading-none">Core DB Ledger</p>
											<p className="mt-1 font-mono text-[9px] text-muted-foreground">AS400 Query Stream</p>
										</div>
									</div>
									<div className="text-right">
										<p className="font-mono text-xs font-semibold tabular-nums text-foreground">1,248 TPS</p>
								...
								{/* Activity Block 2: Critical Event Log Block */}
								<div className="relative overflow-hidden rounded-none border border-red-500/20 bg-red-500/[0.02] p-3">
									<div className="flex items-center justify-between">
										<div className="flex items-center gap-3">
											<ShieldAlert className="h-4 w-4 text-red-500" />
											<div>
												<p className="font-serif text-sm text-foreground leading-none">Terminal B-04 Threat</p>
												<p className="mt-1 font-mono text-[9px] text-muted-foreground">3 AM Credential Stuffing</p>
											</div>
										</div>
									...
									{/* Micro alert trace indicator line */}
									<div className="mt-2 h-1.5 w-full bg-red-500/10">
										<div className="h-full w-full bg-red-500 transition-all duration-1000" style={{ width: "100%" }} />
									</div>
								</div>

								{/* Activity Block 3: Security Keys */}
								<div className="flex items-center justify-between rounded-none border border-border/20 bg-muted/10 p-3">
									<div className="flex items-center gap-3">
										<KeyRound className="h-4 w-4 text-amber-500" />
										<div>
											<p className="font-serif text-sm text-foreground leading-none">SWIFT Gateway Keys</p>
											<p className="mt-1 font-mono text-[9px] text-muted-foreground">Signature Rotation</p>
										</div>
									</div>
									<div className="text-right">
										<p className="font-mono text-xs font-semibold text-foreground">Active</p>
										<span className="inline-block rounded-none bg-amber-500/10 px-1.5 py-0.5 font-mono text-[8px] text-amber-500">
											7 Days Remaining
										</span>
									</div>
								</div>
				...
				<div className="mt-24 sm:mt-32 rounded-none border border-border/30 bg-[#405cfe]/[0.02] p-8 sm:p-12">
					<div className="mx-auto max-w-4xl text-center">
						...
						<blockquote className="mt-6 font-serif text-xl text-foreground leading-relaxed sm:text-2xl">
							...
							extension of ours under heavy regulatory audits.&rdquo;
						</blockquote>
